  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-20 pb-32 px-4 text-center relative overflow-hidden">
        {/* Background blobs */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-indigo-100 rounded-full blur-3xl opacity-50 -z-10" />
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900">Universal Video Downloader</h2>
            <p className="mt-4 text-slate-500">Built for speed, simplicity, and quality.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Support 50+ Sites</h3>
              <p className="text-slate-500">We support all major social media platforms and streaming sites. One tool for everything.</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-slate-500">Download videos in SD, HD, FullHD, 2K, and 4K. We preserve the original source quality.</p>
            </div>
            <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-6 text-blue-600">
                <Zap className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold text-slate-900 mb-3">Fast & Free</h3>
              <p className="text-slate-500">No limits on download speed or file size. Completely free to use forever.</p>
            </div>
          </div>
        </div>
      </section>
